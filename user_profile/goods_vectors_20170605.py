...
# ---------- 读取数据及预处理 ----------
rdd = sqlContext.read.parquet("/sourcedata/linzhen/goods/")
df = rdd.toPandas()
...
dump_svmlight_file(df.values, df.index.values, 'goods_vectors_20170605.libsvm')
